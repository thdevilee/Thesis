...
pltmedquant <- function(data, nms = NA){
  ...
  data_wide <- as.data.frame(do.call(rbind, StabLDA20))
...
```{r}
LDASim <- function(sampsize, n_reps, effect, p, n_perms = 1000, n_tree = 250, leafsize = 5, maxdepth = NA, maxnodes = NA, nodesize = NA){
